...
import { X, Thermometer, Wind, Droplets, Search } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4 sm:p-6">
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl p-4 sm:p-6 w-full max-w-md mx-4">
          ...
          {weather && !loading && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 p-3 sm:p-4 rounded-lg sm:col-span-2">
                  <div className="flex items-center space-x-2 mb-2">
